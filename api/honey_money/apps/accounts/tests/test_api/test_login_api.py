...
LOGIN_SERIALIZER_PATH = "honey_money.apps.accounts.api.v1.serializers.login.LoginSerializer"
...
def test_login_api_success(user_account, unauthorized_api_client, mocker):
    ...
    mocked_login = mocker.patch(
        "honey_money.apps.accounts.services.login.LoginService.login", return_value=mocked_response
    )
